 ...
 * @author hande
 */
public class Piece3 extends  Pieces {
    ...
    public Shape createPiece() {
        ...
        //Yan yana cirlelar için SADECE
         ...
         { 
          arrayOfCircles[i]=createCircle(radius,1150.0f+distance,730.0f);
         ...
         {
          arrayOfCircles[i]=createCircle(radius,1350.0f,730.0f+distance);
          distance = distance + diameter ;
          System.out.println("y"+i);
         }

         shape3 = createUnion(arrayOfCircles);
         shape3.setFill(Color.YELLOW);
