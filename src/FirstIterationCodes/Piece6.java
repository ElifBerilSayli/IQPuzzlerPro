 ...
 * @author giray
 */
public class Piece6 extends  Pieces {
    ...
    public Shape createPiece() {
        ...
        //Yan yana cirlelar için SADECE
         ...
         { 
          arrayOfCircles[i]=createCircle(radius,150.0f+distance,250.0f);
         ...
         {
          arrayOfCircles[i]=createCircle(radius,350.0f,50.0f+distance);
          distance = distance + diameter ;
          System.out.println("y"+i);
         }

         shape3 = createUnion(arrayOfCircles);
         shape3.setFill(Color.CYAN);
